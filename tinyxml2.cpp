...
// {
//     std::queue<const XMLElement*> elementQueue;
...
//     if (element->GetText())
//     {
//         printf("文本: %s", element->GetText());
//     }
//     elementQueue.push(element);
//     // printf("\nbefore while(){} good\n");

//     const XMLElement* tempElement;
//     const XMLElement* childElement;

//     while (!elementQueue.empty())
//     {
//         tempElement = elementQueue.front();
//         elementQueue.pop();
        
//         if (!tempElement->NoChildren())
//         {
//             childElement = tempElement->FirstChildElement();
...
//                 {
//                     printf("文本: %s", childElement->GetText());
//                 }
